...
export let extendNavLaptop = ["Дисконтная карта", "Вакансии", "Оптовикам", "Контакты", "Новости", "Акции", "Франшиза"];
export let footerMagazinList = ["Товары со скидкой", "Новые поступления", "Японские продукты", "Корейские продукты", "Китайские продукты", "Вьетнамские продукты", "Тайские продукты", "Индийские продукты", "Индийские продукты", "Другие продукты"];
...
if(width >= 992){
    ...
    extendNavLaptop = ["Оптовикам", "Контакты", "Новости", "Акции", "Франшиза"];
}
...
export const ratindProducts = [
...

    {
        ...
        rating: 3,
        content: `Соотношение цена-качество на пятерку.
        Бралаадо✌? Получается хорошая основа для супов и...`,
        author: {
